    ...
    return (
        <div  className='px-16'> 
            <div className='about-page'>
                <h1>Hello</h1>
                <h1>I'm <span className='text-primary font-bold'>Mahea</span></h1>
                ...
                <p className='font-bold'>Diploma in Textile: 2020</p>
                <p className='font-bold'>SSC science : 2016</p>
                <br />
                <p className='text-white font-bold text-2xl'>Email Address: bilkscse@gmail.com</p>
            </div>
